...
$result = $conn->query("SELECT id, nombre, apellidos, correo, rol FROM empleados WHERE eliminado = 0");
$eliminados = $conn->query("SELECT id, nombre, apellidos, correo, rol FROM empleados WHERE eliminado = 1");
